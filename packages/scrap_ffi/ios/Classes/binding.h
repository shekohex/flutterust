...
int32_t load_page(RuntimePtr runtime, const char *url, void (*resolve)(char *),
                  void (*reject)(char *), void (*log)(char *));

/**
 * Setup a new Tokio Runtime and return a pointer to it so it could be used
 * later to run tasks
 */
